...
public class PatchBuilderWindow : EditorWindow
{
    ...
    private float _detailProgressBarMax = 100.0f;
    ...
    private float _detailProgressBarMaxPatchBuild = 100.0f;
    ...
    void Init()
    {
        if(!_isInitialized)
        {
	        ...
	        _platformsAvailable = new string[]
	        {
			...
			_detailProgressBarMax -= _detailProgress;
	        _detailProgressBarMaxPatchBuild -= _detailProgressPatchBuild;
    ...
    void OnSetMainProgressBar(int min, int max)
    {
        ...
        _mainProgress = 0;
	    ShowProgressBar(_mainLog, _detailLog, _mainProgress / _mainProgressBarMax);
    }
    ...
    void OnTaskStarted(string message)
    {
        ...
        _endLog = message;
	    _mainLog = "Starting...";
	    _detailLog = "Initializing the process...";
		ShowProgressBar(_mainLog, _detailLog, _mainProgress / _mainProgressBarMax);
	}
    ...
    void OnTaskCompleted(string message)
    {
	    ...
	    _mainLog = "";
	    _detailLog = "";
	    _mainProgressBarMax = 100;
	    _mainProgress = 0;
		_patchBuilderStatus = PatchBuilderStatus.IDLE;
	    HideProgressBar();
    }

	protected void ShowProgressBar(string main, string detail, float progress)
	{
		EnqueueAction(() => EditorUtility.DisplayProgressBar(main, detail, progress));
	}

	protected void HideProgressBar()
	{
		EnqueueAction(() => EditorUtility.ClearProgressBar());
	}
    #endregion
    ...
    void OnSetMainProgressBarPatchBuild(int min, int max)
    {
		...
		ShowProgressBar(_mainLogPatchBuild, _detailLogPatchBuild, _mainProgressPatchBuild / _mainProgressBarMaxPatchBuild);
    }
    ...
    void OnTaskStartedPatchBuild(string message)
    {
	    ...
	    _mainLogPatchBuild = "Starting...";
	    _detailLogPatchBuild = "Initializing the process...";
		ShowProgressBar(_mainLogPatchBuild, _detailLogPatchBuild, _mainProgressPatchBuild / _mainProgressBarMaxPatchBuild);
	}
    ...
    void OnTaskCompletedPatchBuild(string message)
    {
        ...
        _endLogPatchBuild = message;
	    _mainLogPatchBuild = "";
	    _detailLogPatchBuild = "";
	    _mainProgressPatchBuild = 0;
	    _mainProgressBarMaxPatchBuild = 100;
		_patchBuilderStatus = PatchBuilderStatus.IDLE;
	    HideProgressBar();
	}
	#endregion
